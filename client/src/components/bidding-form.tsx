...
export function BiddingForm() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("Submitting bid:", { songUrl, bidAmount, songName, artistName })
        ...
        <Card>
            <CardHeader className="pb-2">
                ...
                <p className="text-sm text-muted-foreground">
                    Current highest bid: <span className="font-semibold text-primary">{currentHighestBid} SONGCOIN</span>
                </p>
            </CardHeader>
            <CardContent>
                {!isConnected ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="rounded-md border bg-secondary/10">
                                <div className="mb-2 flex items-center gap-2 p-3">
                                    ...
                                    <span className="text-sm text-muted-foreground">Paste iframe HTML code below</span>
                                </div>
                                <Textarea
                                    id="song-url"
                            ...
                            <p className="text-xs text-muted-foreground underline">
                                <a href="https://developer.spotify.com/documentation/embeds/tutorials/creating-an-embed" target="_blank" rel="noopener noreferrer">   
                                    We currently only support Spotify embeds. You can get the embed code by right clicking on the Spotify player and selecting "Embed track".
                                </a>
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">Gas fees will be calculated at submission</p>
                        </div>

                        <Button
                            className="mt-2 w-full"
                            variant="secondary"
                            disabled={isSubmitting || !songUrl || !bidAmount || !songName || !artistName || Number.parseFloat(bidAmount) <= currentHighestBid}
